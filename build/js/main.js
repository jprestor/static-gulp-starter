(function () {
  ...
  function initMap() {
    map = new google.maps.Map(document.getElementById("map"), {
      zoom: 15,
      center: centerCords // disableDefaultUI: true
  ...
  var activeSelector = "is-active";

  var dropdownHandler = function dropdownHandler(e) {
    e.preventDefault();
  ...
  /*MODAL---*/
  var activeClass = "modal--show";
  var bodyClass = "compensate-for-scrollbar";
  ...
  $(function () {
    var isFrontPage = $(".front-page").length;
    var isSchoolHistoryPage = $(".pg-school-history").length;

    if (isFrontPage) {
      var $bannerSlider = $(".js-banner-slider");
      $bannerSlider.on("init afterChange", function (event, slick, currentSlide) {
        var i = (currentSlide ? currentSlide : 0) + 1;
        var $currentNum = $(this).find(".js-current-num");
        var $totalNum = $(this).find(".js-total-num");
        $currentNum.text("0" + i);
      ...
      var $columnsSlider = $(".js-four-columns-slider");
      $columnsSlider.slick({
        rows: 0,
        slidesToShow: 4,
        responsive: [{
    ...
    if (isSchoolHistoryPage) {
      var $schoolHistorySlider = $(".js-school-history-slider");
  ...
  $(function () {
    ...
    var intitTabs = function intitTabs() {
      var $allTabs = $('.j-tabs');
      $allTabs.each(function (i, element) {
        var $tab = $(element).find('.j-tab-item');

        if ($tab.hasClass('is-active')) {
          var context = $(element).attr('data-target');
          var isSetDataIndex = $(element).find('[data-tab-index]').length;
          var index = undefined;
          ...
          var $contentContainer = $("[data-tabs-content='".concat(context, "'"));
          var $contentItem = $contentContainer.find('.j-tab-content'); //- Задаем класс is-active для вкладки соответствующей активной кнопке
    ...
    $tab.click(function (e) {
      var $tabs = $(this).closest('.j-tabs');
      var context = $tabs.attr('data-target');
      var $contentContainer = $("[data-tabs-content='".concat(context, "'"));
      var $contentItem = $contentContainer.find('.j-tab-content');
      var isSetDataIndex = $tabs.find('[data-tab-index]').length;
      var index = undefined;
      ...
      $contentItem.removeClass('is-active'); //- Задаем класс is-active для вкладки соответствующей активной кнопке
      //- Задаем высоту контейнера равную высоте активной вкладки
  ...
  var $range = $(".js-range");
  var $money = $(".js-range-money");
  $range.ionRangeSlider({
    min: 0,
    max: 10000,
    from: 500,
    onStart: function onStart(data) {
      $money.text("".concat(data.from, " \u0440\u0443\u0431."));
    },
  ...
  $(function () {
    ...
    var activeNavClass = "main-nav--act";

    var onNavToggleClick = function onNavToggleClick() {
    ...
    var $navToggle = $(".js-main-nav-toggle");
    var $navLink = $(".js-main-nav li a");
    $navToggle.click(onNavToggleClick);
    $navLink.click(onNavLinkClick);
    var secondaryNav = document.querySelector(".js-secondary-nav");
